...
**Professional AI voice receptionist template with intelligent templating system, PII protection, and## 🤖 GitHub Copilot Integrationseamless Retell.ai + n8n integration.**
...
> **Slash Commands for Template System**
> 
> Custom GitHub Copilot slash commands provide architecture-aware assistance for the Layer 7 Voice AI template system.

### 🎯 **Available Slash Commands**

Use these commands in GitHub Copilot Chat for structured, expert guidance:

| Command | Purpose | Example |
|---------|---------|---------|
| `/retell-flow` | Modify Retell agent conversation flows | `/retell-flow Add review request after appointments` |
| `/n8n-workflow` | Create/modify n8n workflows | `/n8n-workflow Build SMS notification system` |
| `/secure-prompt` | Update AI prompts with security | `/secure-prompt Add appointment cancellation instructions` |
| `/extend-template` | Extend template system features | `/extend-template Add Twilio SMS integration` |

### 🚀 **How to Use**

1. **Open GitHub Copilot Chat** in VS Code
2. **Type any slash command** with your description
3. **Get structured guidance** with specific code examples
4. **Follow the provided steps** to implement changes consistently

### 📋 **Command Features**

Each slash command provides:
- **Architecture-aware responses** following established patterns
- **Security guidelines** and PII protection rules  
- **Specific file modifications** with exact code changes
- **Integration steps** across Retell.ai and n8n components
- **Testing and validation** recommendations

### � **Detailed Documentation**

For comprehensive guides, see individual prompt files:
- **[Retell Agent Flow Editing](.github/copilot-prompts/retell-agent-flow-editing.md)**
- **[n8n Workflow Development](.github/copilot-prompts/n8n-workflow-development.md)**  
- **[Prompt Engineering & Security](.github/copilot-prompts/prompt-engineering-security.md)**
- **[Template System Extension](.github/copilot-prompts/template-system-extension.md)**

> 💡 **Pro Tip**: The slash commands understand your entire template system architecture and will provide coordinated changes across multiple files automatically!
